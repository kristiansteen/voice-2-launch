    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        ...
        <div className="max-w-sm text-center relative z-10">
          ...
          <h2 className="text-2xl font-bold mb-4 leading-snug">Your AI process interviewer</h2>
          <p className="text-white/70 leading-relaxed">
            Describe your process out loud. Ailean turns it into a BPMN diagram in minutes.
          </p>
          <div className="mt-10 space-y-3 text-left text-sm text-white/70">
            {[
              'Voice-to-BPMN in minutes',
              'AI-guided process interviews',
              'Export to any BPM platform',
              'Instant improvement suggestions with time & cost estimates',
              'Launch directly into vimpl process suite',
              'Track potential benefits in the overview dashboard',
            ].map(f => (
      ...
      {/* ── Form ── */}
      <div className="flex-1 flex items-center justify-center px-6 py-8 bg-slate-50 relative">
        <div className="absolute top-4 right-4">
          <LangSwitcher />
        </div>
        <div className="w-full max-w-sm">
          <h1 className="text-2xl font-bold text-slate-900 mb-1">Sign in</h1>
          <p className="text-slate-500 text-sm mb-8">Welcome back to Ailean.</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            No account?{' '}
            <button onClick={onSwitchToRegister} className="font-semibold" style={{ color: '#65c434' }}>
              Create one
            </button>
          </p>
        </div>
